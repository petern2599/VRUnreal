...
FString drone_select2;
FString TopicName9;

bool UROSWidget::Initialize()
{
	Super::Initialize();
	FlyOverCharacter->OnClicked.AddDynamic(this, &UROSWidget::StartButtonClicked);
	return true;
}


void UROSWidget::StartButtonClicked()
{
	...
	TopicName9 = drone_select2 + "/fom_enable";
